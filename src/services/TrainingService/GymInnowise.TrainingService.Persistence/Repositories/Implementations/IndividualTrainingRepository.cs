...
{
    public class IndividualTrainingRepository : TrainingRepositoryBase<IndividualTrainingEntity>
    {
        private readonly TrainingServiceDbContext _context;

        public IndividualTrainingRepository(TrainingServiceDbContext context) : base(context)
        {
            _context = context;
        }

        public override async Task<IndividualTrainingEntity?> GetTrainingByIdAsync(Guid trainingId,
